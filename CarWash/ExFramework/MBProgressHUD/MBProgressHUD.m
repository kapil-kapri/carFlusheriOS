...
- (id)initWithView:(UIView *)view {
    ...
    /*CGRect frame = CGRectMake(0.0,
                                   ...
                                   CGRectGetHeight(view.bounds) - 54);*/
	return [self initWithFrame:view.bounds]; //view.bounds
}
...
- (void)layoutSubviews {
    ...
    /*CGRect frame = CGRectMake(0.0,
                              ...
                              CGRectGetHeight(self.bounds) - 54);
	// Entirely cover the parent view
	UIView *parent = self.superview;
	if (parent) {
		self.frame = frame;//parent.bounds;
	}
	CGRect bounds = frame;//self.bounds;*/
